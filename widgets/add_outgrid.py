...
class AddOugrid(widgets.HBox):
    ...
    def __init__(self):
        ...
        self.output_grid_type = widgets.Dropdown(description="Output grid type",options = [0,1],value = 0, style=style)
        self.longitude_of_output_grid = widgets.FloatText(description="Longitude", style=style)
        self.latitude_of_output_grid = widgets.FloatText(description="Latitude", style=style)
        self.number_of_grid_points_x = widgets.IntText(description="Number of grid points x",style=style)
        self.number_of_grid_points_y = widgets.IntText(description="Number of grid points y",style=style)
        self.grid_distance_x = widgets.FloatText(description="Grid distance x",style=style)
        self.grid_distance_y = widgets.FloatText(description="Grid distance y",style=style)
        self.heights_of_levels = widgets.Text(description="Heights of levels",placeholder = '(upper boundary)',style=style)
