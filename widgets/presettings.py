...
class Presettings(widgets.VBox):
    def __init__(self, command_file,
        ...
        acc = widgets.Accordion(children=[widgets.VBox(children=[self.settings,
                                                         self.line,
                                                         widgets.HBox([self.delete_extras_b,
                                                               self.warning_text])
                                                         ]
                                                )
                                         ]
    ...
    def enable_settings(self,change=None):
        ...
        if value is not 'Default':
            ...
            if prev_dict['outgrid_nest'] == 'None':
                ...
                self.basic.outgrid_nest.out_loc.value = list(prev_dict['outgrid_nest'].keys())[0]
            ...
            self.basic.offline_integration_time.value = prev_dict['offline_integration_time']
